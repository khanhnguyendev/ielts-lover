...
import { signInWithGoogle, signInWithEmail } from "@/app/actions"
...
export default function LoginPage() {
    ...
    const handleEmailSignIn = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // success: redirect() is called server-side, component unmounts
        } catch {
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="text-center space-y-2">
                ...
                <p className="text-sm font-medium text-slate-500">
                    ...
                    <Link href={returnTo ? `/signup?from=${encodeURIComponent(returnTo)}` : "/signup"} className="text-primary font-medium hover:underline underline-offset-4">
                        Register for free
                    </Link>
                </p>
            </div>
            ...
            <div className="space-y-4">
                ...
                <form className="space-y-5" onSubmit={handleEmailSignIn}>
                    ...
                    <Button
                        ...
                        className="w-full"
                    >
                        {isEmailLoading ? <PulseLoader size="sm" color="white" /> : "Log in"}
                    </Button>
                </form>
            </div>
