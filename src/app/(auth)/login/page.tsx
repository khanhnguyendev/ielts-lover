    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="space-y-4">
                <Button variant="outline" className="w-full h-12 rounded-lg border-muted bg-white hover:bg-muted/50 transition-all font-medium text-muted-foreground flex items-center justify-center gap-3">
