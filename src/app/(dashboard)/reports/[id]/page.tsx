            ...
            <div className="flex-1 overflow-y-auto p-8 lg:p-12 scrollbar-hide">
                <div className="max-w-4xl mx-auto space-y-10 pb-20">
                    ...
                    <div className="flex items-center justify-between">
                        <Link href="/dashboard/reports" className="flex items-center gap-2 text-sm font-bold text-muted-foreground hover:text-primary transition-colors">
                            <ChevronLeft className="h-4 w-4" />
                            Back
                        </Link>
                        <div className="flex items-center gap-6">
                            <span className="text-sm font-bold text-muted-foreground">Speaking Analysis <span className="text-muted-foreground/40 ml-2">Date: 2026-02-14 23:24:57</span></span>
                    ...
                    {/* Score Overview */}
                    <div className="bg-white rounded-[32px] border p-10 flex items-center justify-between shadow-sm relative overflow-hidden group">
                        ...
                        <div className="flex items-center gap-12 relative z-10">
                            <div className="text-center">
                                <div className="text-6xl font-black font-outfit text-primary flex items-baseline gap-1">
                                    1.0<span className="text-2xl text-muted-foreground/30 font-bold">/9.0</span>
                                </div>
                                <p className="text-[10px] uppercase tracking-[0.2em] font-black text-muted-foreground/60 mt-1">Overall Band Score</p>
                            </div>

                            <div className="w-px h-16 bg-muted mx-2" />

                            <div>
                                <div className="text-4xl font-black font-outfit text-purple-600">A1</div>
                                <p className="text-[10px] uppercase tracking-[0.2em] font-black text-muted-foreground/60 mt-1">CEFR Level</p>
                            </div>
                        </div>

                        <Button className="bg-primary hover:bg-primary/90 text-white rounded-2xl h-14 px-8 font-black text-sm shadow-xl shadow-primary/20 relative z-10">
