    ...
    return (
        <div className="p-8 max-w-6xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-2 duration-500 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2 border-b border-slate-100/50">
                ...
                <div className="flex bg-slate-100 p-1 rounded-full self-start md:self-auto">
                    {[7, 30].map((p) => (
                        <button
                            key={p}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                {/* Left Column: Feature Breakdown & Pricing Strategy */}
                <div className="lg:col-span-9 space-y-12">
                    {/* 3a. Feature Breakdown */}
                ...
                {/* Right Column: Model Pricing Editor */}
                <div className="lg:col-span-3 space-y-6">
                    <div className="flex items-center gap-3 h-10">
                        <div className="w-10 h-10 rounded-[1.25rem] bg-indigo-100 text-indigo-600 flex items-center justify-center">
                            <ShieldCheck size={18} strokeWidth={2.5} />
                        </div>
                        <h2 className="text-xl font-black font-outfit text-slate-900 tracking-tight">Market Rates</h2>
                    </div>
                    ...
                    <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-2xl shadow-indigo-200/50">
                        ...
                        <div className="relative z-10 space-y-8">
                            <div className="space-y-1">
                                <h3 className="text-sm font-black uppercase tracking-[0.2em] text-primary">Token Pricing</h3>
